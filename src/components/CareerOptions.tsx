  ...
  Object.entries(hardcodedCareers).forEach(([parentCategory, subcategories]) => {
    Object.entries(subcategories).forEach(([subCategoryName, data]) => {
      const industryMapping: { [key: string]: string } = {
        ...
        "Environmental and Agricultural Sciences": "Environmental",
      ...
      const colorMapping: { [key: string]: string } = {
        ...
        "Law and Legal Studies": "#FEF7CD",
        "Finance and Accounting": "#FEF7CD",
        "Human Resources": "#FDE1D3",
        "Sales and Marketing": "#FDE1D3",
        "Data Science and Analytics": "#D3E4FD",
        "Entrepreneurship and Startups": "#FDE1D3",
        "Creative Arts": "#E5DEFF",
        "Government and Public Administration": "#FEF7CD",
        "Environmental and Agricultural Sciences": "#E8F5E8",
        "Communications and Media": "#E5DEFF",
        "Sports and Recreation": "#F2FCE2"
      };
